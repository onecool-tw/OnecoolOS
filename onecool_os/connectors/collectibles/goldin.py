"""Local Goldin collectible connector."""
...
class GoldinConnector(BaseCollectibleConnector):
    """Normalize local Goldin records as validation source inputs."""

    connector_name = "goldin"
    source = CollectibleMarketSource.GOLDIN
